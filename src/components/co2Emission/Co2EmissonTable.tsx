...
interface Co2EmissionTableProps {
  activeTab: string;
  setActiveTab: (tab: string) => void;
}

const Co2EmissionTable: React.FC<Co2EmissionTableProps> = ({ activeTab, setActiveTab }) => {
  const tabs = [
  ...
  return (
    <div className="flex gap-1 mb-6  bg-white dark:bg-gray-800 px-4 py-2 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
      {tabs.map((tab) => {
        const Icon = tab.icon;

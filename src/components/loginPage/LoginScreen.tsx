...
const LoginScreen: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (activeTab === "userid") {
      ...
      console.log("Login with Emp ID:", {
        empid: formData.empid,
        dob: formData.dob,
      });
    }
  };
  // idhu organization suggestion
        ...
        <div className="flex items-center justify-center p-6 lg:p-10">
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full bg-primary text-white py-2.5 px-5 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center gap-2 group text-sm"
              >
                Sign In

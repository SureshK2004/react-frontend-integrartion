...
const TimeSheetTask: React.FC = () => {
    ...
    const fetchTasks = async () => {
        try {
            const res = await getTasks(org_id);
    ...
    const handleDelete = async () => {
        await deleteTask(selectedItem.id, org_id);
                ...
                <div className="bg-white dark:bg-gray-800 px-6 py-4 rounded-lg shadow-sm border">
                    ...
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-3 py-2 bg-gray-100 dark:bg-gray-700 rounded-lg text-sm"
                        >
                            <ArrowBigDownDash size={18} /> Add Task
                        </button>
                    </div>
                    ...
                    <AddModal
                        ...
                        onSubmit={handleAdd}
                        fields={[{ label: "Task Name", key: "taskName" }]}
                    />
                    ...
                    <EditModal
                        ...
                        onSubmit={handleEdit}
                        fields={[{ label: "Task Name", key: "taskName" }]}
                        initialData={{ taskName: selectedItem?.task_name || "" }}
                    />
                    ...
                    <DeleteModal
                        ...
                        itemName={selectedItem?.task_name}
                    />

...
const Relationship: React.FC = () => {
    ...
    // Dummy Data
    const Relationship = [
        { id: 1, Relation: "Chennai", },
        { id: 2, Relation: "Bangalore", },
        { id: 3, Relation: "Tambaram", },
        { id: 4, Relation: "Thiruvanmiyur", },

    ];

    const totalPages = Math.ceil(Relationship.length / itemsPerPage);

    const columns = [
        { key: "id", label: "S.No" },
        { key: "Relation", label: "Relation Name" },
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 px-6 py-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white dark:bg-gray-800 px-6 py-4 space-y-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 mb-6">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center justify-end gap-3">
                            ...
                            <AddModal
                                ...
                                onSubmit={handleAdd}
                                fields={[
                                    { label: "Relation Name", key: "Relation" },
                                ]}
                            />
                        </div>
                    </div>
                    ...
                    <TableComponent
                        tableId="Relation-table-details"
                        columns={columns}
                        data={Relationship.map((d) => ({
                            ...d,

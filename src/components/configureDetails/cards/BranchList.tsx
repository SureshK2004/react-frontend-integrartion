...
const BranchList: React.FC = () => {
    ...
    // Dummy Data
    const BranchList = [
        { id: 1, BranchName: "Chennai", },
        { id: 2, BranchName: "Bangalore", },
        { id: 3, BranchName: "Tambaram", },
        { id: 4, BranchName: "Thiruvanmiyur", },

    ];

    const totalPages = Math.ceil(BranchList.length / itemsPerPage);

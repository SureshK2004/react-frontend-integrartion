...
const BranchList: React.FC = () => {
    ...
    const fetchBranches = async () => {
        ...
        const total = res?.pagination?.count ?? list.length;
        setTotalCount(total);
                ...
                <div className="bg-white dark:bg-gray-800 px-6 py-4 rounded-lg shadow-sm border mb-6">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            <button
                                onClick={() => navigate(-1)}
                                className="flex items-center gap-2 px-3 py-2 text-sm font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg"
                            >
                ...
                <div className="bg-white dark:bg-gray-800 px-6 py-4 rounded-lg shadow-sm border">
                    ...
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-3 py-2 text-sm bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg"
                        >
                    ...
                    <DeleteModal
                        ...
                        itemName={selectedItem?.branch_name}
                    />

  ...
  const fetchList = async () => {
    ...
    try {
      ...
      const mapped = list.map((l: any) => ({
        id: l.id,
        name: l.name,
        no_of_leave: String(l.no_of_leave ?? ""),
        leave_config_type: l.leave_config_type,
        monthly_split: Boolean(l.monthly_split),
        leave_carry_forward: Boolean(l.leave_carry_forward),

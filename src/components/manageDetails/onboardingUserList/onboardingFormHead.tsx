// components/locationDetail/onboardingFormHead.tsx
import React from 'react';
import { ThemeToggle } from '@/components/theme-toggle';
import { ArrowLeft } from 'lucide-react';
import { useNavigate } from "react-router-dom";

interface OnboardingFormHeadProps {
  // Removed tab-related props since we're removing tabs
}

const OnboardingFormHead: React.FC<OnboardingFormHeadProps> = () => {
    ...
    <div className="bg-white dark:bg-gray-800 px-6 py-4 space-y-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 mb-6">
      <div className="flex items-center justify-between">
        <div className="flex flex-col space-y-4">
          ...
          {/* Removed tabs section completely */}
        </div>
...
export default OnboardingFormHead;
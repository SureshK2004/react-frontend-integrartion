...
//organisation
import CreateOrganisation from "./orgainsation/Createorganisation";
import OrganisationList from "./orgainsation/OrganisationDetails";
import SitesManagement from "./components/configureDetails/cards/sites";
import ProtectedRoute from "./components/ProtectedRoute";
import ClientSiteManagement from "./components/configureDetails/cards/ClientSiteManagement";
import ClientsManagement from "./components/configureDetails/cards/Client";
import CreateClient from "./components/configureDetails/cards/CreateClient";
import EditClient from "./components/configureDetails/cards/EditClient";
import CreateSite from "./components/configureDetails/cards/CreateStie";
import EditSite from "./components/configureDetails/cards/EditSite";
            ...
            <ProtectedRoute>
              <Layout>
                <Routes>
                  ...
                  <Route path="/config/client_site" element={<ClientSiteManagement />} />
                  <Route path="/congif/client_site/client" element={<ClientsManagement />} />

                  <Route path="/clients/create" element={<CreateClient />} />
                  <Route path="/clients/edit/:id" element={<EditClient />} />

                  <Route path="/congif/client_site/site" element={<SitesManagement />} />
                  ...
                  <Route path="/org-details" element={<OrganisationList />} />
